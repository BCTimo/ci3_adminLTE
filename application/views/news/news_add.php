				...
				<form action="<?=base_url();?>news/save" method="post" role="form">
					<div class="box-body">
						...
						<div class="form-group">
							<input type="name" name="name" class="form-control" placeholder="新聞標題" required>
						</div>
					</div>
